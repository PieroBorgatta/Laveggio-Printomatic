...
1. Leggere sulla scheda se è V2/CST3530 o V1/CST328 e scegliere il relativo
   file factory.
2. Controllare la polarità della LiPo 803040 da 1000 mAh con connettore JST
   1,25 mm e la continuità di tutti i cavi I2C.
3. Inserire a dispositivo spento la SanDisk Extreme microSDXC da 128 GB già
   verificata in lettura/scrittura e formattata FAT32 (exFAT non è supportato
   dal runtime Arduino).
4. Collegare inizialmente solo USB-C, senza batteria, multiplexer o sensori.
5. Per l'antenna esterna, verificare che pigtail e antenna siano SMA standard e
   non RP-SMA. Controllare con lente o microscopio la resistenza RF spostata a
   sinistra con saldatore ad aria calda e flussante, prima di alimentare.
...
- abilitare l'audio dal portale e verificare entrambi gli speaker;
...
- disabilitare l'audio lasciando acceso il display: nessuno dei due speaker deve
  più suonare;
...
- scollegare e ricollegare USB verificando log e continuità operativa;
