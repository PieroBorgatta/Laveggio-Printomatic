...
export function createSimulator(){
  ...
  const server=createHttpServer(async(request,response)=>{
    ...
    if(request.method==='GET'&&url.pathname==='/api/logs'){response.writeHead(200,{'content-type':'text/plain; charset=utf-8'});return response.end('[info] device_started firmware=1.0.1-simulator\n[info] wifi_connected 192.168.0.42\n[info] sd_mounted 119.1 GB\n[info] sensor_bus_ready mux=0x70')}
