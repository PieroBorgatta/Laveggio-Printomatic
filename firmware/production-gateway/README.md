...
Misure della build `2.0.5` verificata il 4 settembre 2026 sul profilo Waveshare V2:

- RAM statica: `54.444 / 327.680 byte` (`16,6%`);
- flash applicazione: `1.667.662 / 6.291.456 byte` (`26,5%`).
